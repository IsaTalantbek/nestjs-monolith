...
CREATE TABLE `accounts` (
    ...
    `create_by` VARCHAR(191) NOT NULL DEFAULT 'System',
    `update_at` DATETIME(3) NOT NULL,
    `update_by` VARCHAR(191) NOT NULL DEFAULT 'System',
...
CREATE TABLE `Subcribe` (
    ...
    UNIQUE INDEX `Subcribe_userId_profileId_key`(`userId`, `profileId`),
    PRIMARY KEY (`id`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
CREATE TABLE `black_list` (
    ...
    UNIQUE INDEX `black_list_userId_vsProfileId_key`(`userId`, `vsProfileId`),
    PRIMARY KEY (`id`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
-- AddForeignKey
ALTER TABLE `Subcribe` ADD CONSTRAINT `Subcribe_userId_fkey` FOREIGN KEY (`userId`) REFERENCES `accounts`(`id`) ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE `Subcribe` ADD CONSTRAINT `Subcribe_profileId_fkey` FOREIGN KEY (`profileId`) REFERENCES `profiles`(`id`) ON DELETE RESTRICT ON UPDATE CASCADE;
